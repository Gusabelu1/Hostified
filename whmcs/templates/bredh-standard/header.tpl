...
<div id="coodiv-header" class="d-flex mx-auto flex-column {if $templatefile == 'homepage'}{else}subpages-header{/if}"><!-- start header -->
		...
		<li><i class="bredhicon-chat-inv"></i> soporte@hostified.me</li>
		</ul>
		...
		<a class="navbar-brand" href="{$WEB_ROOT}/index.php" style="color: #fff; font-size: 2.5rem; font-weight: 1000;">HOSTIFIED</a>
                ...
                <div class="coodiv-colpass-menu-header navbar-offcanvas" id="offcanvas-menu-home">
                    ...
                    <li class="nav-item"> <a href="" class="nav-link" id="webhosting-megamenu"></a> </li>
                        ...
                        {if $registerdomainenabled || $transferdomainenabled}
                            <div class="item header-btn-services-whmcs">
                                <a id="btnBuyADomain" href="domainchecker.php">
									...
									<img src="{$WEB_ROOT}/templates/{$template}/img/svgs/Arrow-0.svg" alt=""/>
                                </a>
                            </div>
                        {/if}
